...
make_new_schedule = False   # Make new schedules.
sched_count = 2             # Number of new schedules to generate that will be randomly pulled from.
...
while True == True:
    ...
    if channel_curr != channel_prev:
        ...
        os.system('xrandr --output HDMI-1 --brightness '+str(bri_min))
        ...
        if play == False:
            ...
            with open("temp.py", "w") as job_file:
                ...
                job_file.write("os.system('DISPLAY=:0 vlc /home/andrewdmarques/Desktop/TV/static.mp4 --video-wallpaper')")
        ...
        if play == True:
            ...
            with open("temp.py", "w") as job_file:
                ...
                job_file.write("import os\n")
                #job_file.write("media = '"+prog_dir_curr[0]+"'\n")
                job_file.write("os.system('DISPLAY=:0 vlc " + prog_dir_curr[0] + " --video-wallpaper --start-time="+str(prog_time_start[0])+"')")

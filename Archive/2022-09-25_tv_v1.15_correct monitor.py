    ...
    if channel_curr != channel_prev:
        ...
        if play == False:
            ...
            with open("temp.py", "w") as job_file:
                ...
                job_file.write("os.system('DISPLAY=:0 vlc /home/andrewdmarques/Desktop/TV/static.mp4')")
        ...
        if play == True:
            ...
            with open("temp.py", "w") as job_file:
                ...
                job_file.write("import os\n")
                #job_file.write("media = '"+prog_dir_curr[0]+"'\n")
                job_file.write("os.system('DISPLAY=:0 vlc " + prog_dir_curr[0] + " --start-time="+str(prog_time_start[0])+"')")

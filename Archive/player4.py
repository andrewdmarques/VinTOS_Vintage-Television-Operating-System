...
while True == True:
    ...
    if exists('/home/andrewdmarques/Desktop/TV/player-on.txt'):
        ...
        if exists('/home/andrewdmarques/Desktop/TV/temp.py'):
            time.sleep(0.1) # Pause to allow the text to be finished writting
            os.system('sudo chmod +x /home/andrewdmarques/Desktop/TV/temp.py')
            os.system('python3 /home/andrewdmarques/Desktop/TV/temp.py')

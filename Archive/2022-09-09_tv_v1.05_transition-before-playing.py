...
time_delay_channel = 9     # Time (seconds) to allow for transition before playing the program after a channel change or a program ends.
...
while x < 120:
    ...
    if channel_curr != channel_prev:
        ...
        os.system('xrandr --output HDMI-1 --brightness 0.0')
